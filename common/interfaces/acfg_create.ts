...
export interface IAssetCreateTx extends IBaseTx {
  type: string | undefined,                   //"acfg"
  assetTotal: BigInt | undefined,             //uint64	  "t"	    The total number of base units of the asset to create. This number cannot be changed.
  ...
  assetUnitName?: string | null,              //string	  "un"	  The name of a unit of this asset. Supplied on creation. Example: USDT
  assetName?: string | null,                  //string	  "an"	  The name of the asset. Supplied on creation. Example: Tether
  assetURL?: string | null,                   //string    "au"	  Specifies a URL where more information about the asset can be retrieved. Max size is 32 bytes.
  ...
  assetManager?: string | null,               //Address	  "m"	    The address of the account that can manage the configuration of the asset and destroy it.
  assetReserve?: string | null,               //Address	  "r"	    The address of the account that holds the reserve (non-minted) units of the asset. This address has no specific authority in the protocol itself. It is used in the case where you want to signal to holders of your asset that the non-minted units of the asset reside in an account that is different from the default creator account (the sender).
  assetFreeze?: string | null,		            //Address	  "f"	    The address of the account used to freeze holdings of this asset. If empty, freezing is not permitted.
  assetClawback?: string | null,		          //Address	  "c"	    The address of the account that can clawback holdings of this asset. If empty, clawback is not permitted.
}
